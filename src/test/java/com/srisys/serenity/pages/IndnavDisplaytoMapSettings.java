...
public class IndnavDisplaytoMapSettings extends PageObject {
	...
	public void openPage(){
		...
		try {
			...
			System.out.println("Exception Message="+ex.getMessage());
		     ...
		     public void DisplaytoMapSettingspage() throws InterruptedException{
				...
				lookupsElem1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AcceptanceSuite.props.getProperty("DisplaytoMapSettings"))));
				lookupsElem1.click();
			...
			public void DisplaytoMapSettingsviewpage() throws FileNotFoundException, IOException, InterruptedException {
				//prop = new Properties();
		       // prop.load(new FileInputStream("serenity.properties"));
		        WebDriverWait wait=new WebDriverWait(this.getDriver(), 20);
		        
		        WebElement lookupsupviewElem;
		        lookupsupviewElem = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AcceptanceSuite.props.getProperty("DisplaytoMapSettingsView_Record"))));
		        lookupsupviewElem.click();
		        
		        WebElement displayclose;
		        displayclose = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AcceptanceSuite.props.getProperty("DisplaymapViewclose"))));
		        displayclose.click();
...
//				AdvSearchClearData.click();
			...
			public void DisplaytoMapSettingseditRecord() {
				WebDriverWait wait=new WebDriverWait(this.getDriver(), 200);
				WebElement EditButton;
				EditButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AcceptanceSuite.props.getProperty("DisplaytoMapSettingsEdit_Button"))));
				EditButton.click();
			...
			public void DisplaytoMapSettingseditRecordFields() {
				WebDriverWait wait=new WebDriverWait(this.getDriver(), 200);
				
				Select AdvSearchAvailableFleetColor1 = new Select(
						wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AcceptanceSuite.props.getProperty("DisplaytoMapSettingsEdit_Page")))));
				AdvSearchAvailableFleetColor1.selectByVisibleText(AcceptanceSuite.props.getProperty("DisplaytoMapSettingsEdit_PageData"));
				
				
				WebElement SubmitButton;
				SubmitButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AcceptanceSuite.props.getProperty("DisplaytoMapSettingsEdit_SubmitButton"))));
				SubmitButton.click();
